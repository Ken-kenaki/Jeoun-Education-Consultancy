              ...
              {filteredImages.map((img) => (
                ...
                >
                  ...
                  <div className="p-2 text-center">
                    <p className="text-sm font-medium truncate text-[#232E2F]">
                      {img.name}
                    </p>
                  </div>
                </article>
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/40 to-transparent flex flex-col justify-end p-6 transition-all duration-300 group-hover:bg-black/70">
                        ...
                        >
                          <div className="pt-4 border-t border-white/30">
                            <p className="text-white/90">Click to view full size</p>
                          </div>
                        </motion.div>
                      </div>
                    </motion.div>
          ...
          >
            ...
            >
              <button
                ...
                className="absolute top-4 right-4 bg-black/50 rounded-full p-2 focus:outline-none focus:ring-2 focus:ring-white"
              >
