    ...
    <div className="min-h-screen bg-gradient-to-br from-[#F5F4F5] via-white to-[#B2ACCE]/20 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      >
        <div>
          ...
          >
            <h2 className="text-3xl font-bold text-[#2C3C81]">Create Account</h2>
        ...
        >
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="text-center">
              <p className="text-sm text-[#2C3C81]/70">
                Already have an account?{" "}
                <Link
                  href="/login"
                  className="font-medium text-[#C73D43] hover:text-[#2C3C81] transition-colors"
                >
                  Sign in
                </Link>
              </p>
