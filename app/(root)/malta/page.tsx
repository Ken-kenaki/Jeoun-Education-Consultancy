...
export default function MaltaPage() {
  ...
  const otherCountries = [
    { name: "South Korea", countryCode: "kr", link: "/south-korea" },
    { name: "Malta", countryCode: "mt", link: "/malta" },
    { name: "Australia", countryCode: "au", link: "/australia" },
    { name: "UK", countryCode: "gb", link: "/uk" },
  ];
        ...
        <div className="relative bg-gradient-to-r from-[#2C3C81] to-[#C73D43] text-white py-20 md:py-32">
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <span className="flag-icon flag-icon-mt"></span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {otherCountries.map((country, index) => (
                ...
                >
                  <span className={`flag-icon flag-icon-${country.countryCode} text-4xl mb-3 inline-block`}></span>
