...
export default function AboutPage() {
  ...
  // Fetch stats and milestones from API
    ...
    <main className="overflow-x-hidden">
      ...
      <div className="w-full max-w-[100vw] min-h-screen pt-32 bg-gradient-to-br from-[#F5F4F5] via-white to-[#B2ACCE]/20">
          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {[
                ...
                `Comprehensive test preparation programs (${stats[0].number} students guided)`,
                `Strong university partnerships (${stats[2].number} universities)`,
                `High visa success rate (${stats[3].number})`,
        ...
        <motion.section
          ...
          transition={{ duration: 0.8 }}
          viewport={{ once: true }}
          className="py-16 px-4 bg-gradient-to-r from-[#003580] to-[#CD0E2D]"
        >
          <div className="container mx-auto text-center">
            ...
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              Join {stats[0].number} successful students who have achieved their
            ...
            <Link href="/contact">
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="bg-[#2C3C81] text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-white hover:text-[#2C3C81] transition-colors"
              >
